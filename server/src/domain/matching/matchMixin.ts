...
import fhirWrapperFactory from '@infra/fhir/fhir.ts';
const fhirWrapper = fhirWrapperFactory();
import medMatching from '@domain/matching/medMatching.ts';
import esMatching from '@domain/matching/esMatching.ts';
