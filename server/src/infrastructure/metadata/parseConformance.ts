...
export default class ParseConformance {
    structureDefinitions;
    parsedStructureDefinitions;
    parsedValueSets;
    codeSystems;

    constructor(loadCached) {
        this.structureDefinitions = [];
        this.parsedStructureDefinitions = loadCached ? JSON.parse(fs.readFileSync(new URL('./profiles/types.json', import.meta.url), 'utf8')) : {};
        this.parsedValueSets = loadCached ? JSON.parse(fs.readFileSync(new URL('./profiles/valuesets.json', import.meta.url), 'utf8')) : {};
        this.codeSystems = [];
    }
}
...
//# sourceMappingURL=parseConformance.ts.map
